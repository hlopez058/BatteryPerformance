...
MODEL               = Load_Simulation_07
MODULES             = rt_matrx.c rt_printf.c Load_Simulation_07_capi.c Load_Simulation_07_data.c Load_Simulation_07_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE            = Load_Simulation_07.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/hlope/OneDrive/Documents/GitHub/BatteryPerformance/battery_models
S_FUNCTIONS         = rtiostream_utils.c sfun_spid_contc.c
...
PCMATLABROOT        = C:\\Program Files\\MATLAB\\R2017a
...
MODELLIB                  = Load_Simulation_07lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Load_Simulation_07_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/Load_Simulation_07 \
...
ifeq ($(MODELREF_TARGET_TYPE), NONE)
    ...
    REQ_SRCS           = $(MODEL).c $(MODULES) $(EXT_SRC) \
                         raccel_sup.c raccel_mat.c common_utils.c raccel_utils.c simulink_solver_api.c
    ifneq ($(ENABLE_SLEXEC_SSBRIDGE), 0)
...
LIBSL_SERVICES = $(MATLAB_ROOT)\extern\lib\win64\microsoft\sl_services.lib
...
MAT_LIBS = $(LIBUT) $(LIBMX) $(LIBMEX) $(LIBMAT) $(LIBMWMATHUTIL) $(LIBSL_FILEIO) $(LIBSL_SERVICES) $(LIBSIGSTREAM) $(LIBSLIO_CORE) $(LIBSLIO_CLIENTS)
...
MAT_LIBS += $(MATLAB_ROOT)\extern\lib\win64\microsoft\libmwsl_iofile.lib
